            ...
            <div className="w-full max-w-md bg-white/95 dark:bg-[#1a1b26]/95 backdrop-blur-xl border border-border-color rounded-xl shadow-2xl overflow-hidden flex flex-col scale-100 animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6 grid grid-cols-2 gap-4">
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-text-secondary group-hover:text-text-primary">Import from Clipboard</span>
                    </button>
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-text-secondary group-hover:text-text-primary">Manual Configuration</span>
                    </button>
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-text-secondary group-hover:text-text-primary">Scan QR Code</span>
                    </button>
                ...
                <div className="px-6 pb-6 pt-2">
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-card-bg px-2 text-xs text-text-secondary uppercase">Or paste link</span>
                        </div>
                    </div>
