...
export function NodeEditor({ isOpen, initialNode, onClose, onSave }: NodeEditorProps) {
    ...
    return (
        <div className="absolute inset-0 z-50 flex items-center justify-center p-6 backdrop-blur-md bg-black/40 animate-in fade-in duration-500">
            <div className="w-full max-w-lg bg-surface border border-border-color rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden animate-in zoom-in-95 duration-500 flex flex-col max-h-[90vh] relative -mt-8">
                {/* Header */}
