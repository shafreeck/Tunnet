...
async function run() {
    ...
    const platformsMapping = {
        ...
        'linux-aarch64-deb': ['arm64.deb', 'aarch64.deb'],
        'linux-aarch64-rpm': ['aarch64.rpm', 'arm64.rpm'],
        'linux-aarch64-appimage': ['aarch64.AppImage.tar.gz', 'arm64.AppImage.tar.gz', 'aarch64.AppImage', 'arm64.AppImage'],
